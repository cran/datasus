...
#' child mortality data focused on brazilian cities.
#'
#' @usage sim_inf10_mun(linha = "Município", coluna = "Não ativa",
...
sim_inf10_mun <- function(linha = "Munic\u00edpio", coluna = "N\u00e3o ativa", conteudo = 1, periodo = "last", municipio = "all", capital = "all",
  ...
  page <- xml2::read_html("http://tabnet.datasus.gov.br/cgi/deftohtm.exe?sim/cnv/inf10br.def")
